/* ---------------------------------------------------------------------------
 * Seeded 2D simplex noise + fBm helper.
 * Self-contained (no dependency) so terrain and procedural textures are
...
/** Classic 2D simplex noise (Gustavson-style), output roughly in [-1, 1]. */
